...
{ name:"Le Pouce" , 
  ...
  address:"Pouce street ",
  longitude:"57.5222",
  latitude:"-20.1950",
  duration:"4hr",
  image_url:"https://res.cloudinary.com/trip-buddy/image/upload/v1629446383/trip%20buddy/sightseeing/hiking-le-pouce-in-mauritius-24-e1553499796840_d2mrlo.jpg",
  price: 1200,
  stop_1:'Snail Rock',
  stop_1_lat:'-20.20087446',
  stop_1_long:'57.50608954',
  stop_1_img_url:"https://res.cloudinary.com/trip-buddy/image/upload/v1629446647/trip%20buddy/road%20trip/snail_rock_ny4oai.jpg",
  stop_2:'Wild path an extension to your trip for the most adventurous among you',
  stop_2_lat:'-20.20571505',
  stop_2_long:'57.48853777',
  stop_2_img_url:"https://res.cloudinary.com/trip-buddy/image/upload/v1629446723/trip%20buddy/road%20trip/Sumatra-11_httjvh.jpg",
  choice:"day",
  category:"hiking"
  }
  ...
  stop_1_lat:"-20.43503289529492",
  stop_1_long:"57.32089497404026",
...
{ name: "Pieter Both", 
  ...
  address:"Vallee des Pretres,port louis" ,
  longitude:"57.5552",
  latitude:"-20.1923",
...
{ name:"The Trois Mamelles" , 
  ...
  address:"Holyrood road 1" ,
  longitude:"57.44833",
  latitude:"-20.31022",
  duration:"3hr",
  image_url:"https://res.cloudinary.com/trip-buddy/image/upload/v1629446812/trip%20buddy/road%20trip/trois-mamelles-hiking-trip_5_w1vmrb.jpg",
  price: 800,
  stop_1:'Cascavelle shopping centre',
  stop_1_lat:'-20.28696984211677',
  stop_1_long:' 57.41659595053459',
  stop_1_img_url:"https://res.cloudinary.com/trip-buddy/image/upload/v1629447036/trip%20buddy/road%20trip/cascavelle-shopping-village-5_gthwrq.jpg",
  stop_2:'Beaux Songes Waterfalls - Hiking and Exploring Mauritius meeting point',
  stop_2_lat:'-20.28245801769734', 
  stop_2_long:'57.430325576361035',
  stop_2_img_url:"https://res.cloudinary.com/trip-buddy/image/upload/v1629447108/trip%20buddy/road%20trip/download_blo0ez.jpg",
  choice:"night",
  category:"hiking"
  }
...
{ name:"The Corps de Garde" , 
  ...
  address:"Cretin avenue" ,
  longitude:"57.4456",
  latitude:"-20.2569",
  duration:"2hr",
  image_url:"https://res.cloudinary.com/trip-buddy/image/upload/v1629447625/trip%20buddy/sightseeing/corp_de_garde_okdsn4.jpg",
  price: 900,
  stop_1:'La Ferme Reservoir',
  stop_1_lat:'-20.25474757524095', 
  stop_1_long:'57.43178619549269',
  stop_1_img_url:"https://res.cloudinary.com/trip-buddy/image/upload/v1629447764/trip%20buddy/sightseeing/33308109672_8516b2bf0c_b_ssuo1h.jpg",
  stop_2:'Jains Little India Restaurant',
  stop_2_lat:'-20.261816400475656', 
  stop_2_long:'57.486507120756315',
  stop_2_img_url:"https://res.cloudinary.com/trip-buddy/image/upload/v1629447961/trip%20buddy/sightseeing/happy-rajah-indian-restaurant_nck6vv.jpg",
  choice:"night",
  category:"hiking"
  }

  hiking_trip6 =
  { name:" Tourelle de Tamarin" , 
    ...
    address:"All. des bois reinettes",
    longitude:"57.37467",
    latitude:"-20.34703",
    duration:"4 hr",
    image_url:"https://res.cloudinary.com/trip-buddy/image/upload/v1629448060/trip%20buddy/sightseeing/une-journee-de-randonnee-y-la-tourelle-de-tamarin_mnc4km.jpg",
    price: 780,
    stop_1:"Tamarin Public Beach clear blue sea and white sandy beaches, Blue Bay Marine Park is a must see! There you will find rare corals and fish species in a depth of 5.5 meters.",
...
sight_seeing2 = {  
  ...
  image_url:"https://res.cloudinary.com/trip-buddy/image/upload/v1629446173/trip%20buddy/golf/citadelle_ko5nsc.jpg",
  price: 200,
...
sea_cruise_trip3 =
   ...
   sea_cruise_trip4 = 
   { name: "Iles aux cerf cruise", 
   address:"Belle mare beach",
   ...
   duration:"6 hours" ,
   longitude:"57.803862579083564",
   latitude:"-20.269803381641456",
   price:3000,
   ...
   sea_cruise_trip5 =
   { name: "Iles aux benitiers cruise", 
      address:"Tamarin bay area",
      ...
      longitude:"57.345089377034405",
      latitude:"-20.416262290242873",
      price: 1999,
    ...
    { name: "Saint Brandon", 
      ...
      duration: "11 hours ",
      longitude:"59.55222123792381",
      latitude:"-16.796214703153506",
      price:7500,
...
[sea_cruise_trip1, sea_cruise_trip2, sea_cruise_trip3,sea_cruise_trip4,sea_cruise_trip5,sea_cruise_trip6 ].each do |attributes|
  trip = Trip.create!(attributes)
  puts "Created #{trip.name}"
  end
...
golf_course1 = {
  ...
  address:"Suffolk Close, Vacoas",
  description:" The course was designed and built by the British Royal Navy army at 1902.The Gymkhana Club being the most ancient golf course of Mauritius may not feature all the complexities of modern golf courses, but it is perfectly maintained. It is surely the most affordable 18-hole course of Mauritius.",
  duration:"All day",
  longitude:" 57.498824037820576",
  latitude:"-20.288326764265236",
  price:1500,
  image_url:"https://res.cloudinary.com/trip-buddy/image/upload/v1629446173/trip%20buddy/golf/gymkhana-golf-club-mauritius_z6qzrh.jpg",
  choice:"day",
  category:"golf"
}
golf_course2 = {
  name:"Tamarina Golf Estate",
  address:" Tamarin Bay, near the village of Tamarin",
  description:"The Tamarina Golf Course is situated on a beautiful estate 206 hectares of land at Tamarin on the Western coast of the island. This unique Estate is not only a haven of peace but also a golfer's dream with gentle breezes and the lowest average rainfall of the island!",
  duration:"All day",
  longitude:"-57.39754230023378",
  latitude:"20.29433440657726",
  price:8500,
  image_url:"https://res.cloudinary.com/trip-buddy/image/upload/v1629446173/trip%20buddy/golf/tamarina-golf-club_sgy4pj.jpg",
  choice:"day",
  category:"golf"
}
golf_course3 = {
  name:"Golf du Château",
  address:"Domaine Bel Ombre, Bel Ombre",
  description:"Attached to the Heritage Le Telfair Golf & Spa Resort, the magnificent 18 hole ‘Golf du Château’, situated in the heart of the unspoiled south of Mauritius. The course has scenery typical of Mauritius with its volcanic mountain backdrop and some breathtaking views out to sea.",
  duration:"All day",
  longitude:"57.41348802707861",
  latitude:"-20.495311392639714",
  price:8250,
  image_url:"https://res.cloudinary.com/trip-buddy/image/upload/v1629446173/trip%20buddy/golf/golf-du-chateau-golf-course_k3ojos.jpg",
  choice:"day",
  category:"golf"
}
golf_course4 = {
  name:"Maritim Hotel Golf Course ",
  address:"Maritim Hotel, Balaclava",
  description:"The hotel has a 9-hole (par 29) golf course, the longest hole of which is 340 meters. The Maritim golf course is designed by Graham Marsh and the golf-pro. Each hole can be played from 2 different tees. Driving range and putting green. Golf-pro available for individual lessons, beginners and advanced courses.",
  duration:"All day",
  longitude:"57.51572789594097",
  latitude:"-20.060020295693306",
  price:4000,
  image_url:"https://res.cloudinary.com/trip-buddy/image/upload/v1629446173/trip%20buddy/golf/maritim-golf-course-mauritius_vdwbnr.jpg",
  choice:"day",
  category:"golf"
}
golf_course5 = {
  name:"Mont Choisy Golf Course",
  address:" Mont Choisy - North of Mauritius",
  description:"Mont Choisy Le Golf is much more than a new championship course. It is first of all, a Mauritian Golf Course which showcases the natural beauty of the North of the island, complemented with its mountain views and the historical heritage of the place.",
  duration:"All day",
  longitude:"57.55838416833161",
  latitude:"-20.016897672983102",
  price:5500,
  image_url:"https://res.cloudinary.com/trip-buddy/image/upload/v1629446173/trip%20buddy/golf/mont-choisy-golf-course_qiwxp1.jpg",
  choice:"day",
  category:"golf"
}

golf_course6 = {
  name:"The Legend Golf Course",
  address:"Belle Mare Plage hotel",
  description:"'The Legend', designed by South African champion, Hugh Baiocchi, is the crowning achievement of the Resort, located along one of the most superb beaches on the island.",
  duration:"All day",
  longitude:"57.765838553127", 
  latitude:"-20.167360762646695",
  price:5500,
  image_url:"https://res.cloudinary.com/trip-buddy/image/upload/v1629446173/trip%20buddy/golf/the-legend-golf-course_i3o7qn.jpg",
  choice:"day",
  category:"golf"
}

[golf_course1, golf_course2, golf_course3,golf_course4,golf_course5,golf_course6 ].each do |attributes|
  trip = Trip.create!(attributes)
  puts "Created #{trip.name}"
  end
  puts "Finished creating golf courses trips!"
